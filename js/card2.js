...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 6749.99;
        const parcelas = [
            { num: 2, valorParcela: 3374.995 },
            { num: 3, valorParcela: 2249.996666666667 },
            { num: 4, valorParcela: 1687.4975 }, 
            { num: 5, valorParcela: 1349.998 },
            { num: 6, valorParcela: 1124.998333333333 },
            { num: 7, valorParcela: 964.2842857142857 },
            { num: 8, valorParcela: 843.74875 },
            { num: 9, valorParcela: 749.9988888888889 },
            { num: 10, valorParcela: 674.999 },
